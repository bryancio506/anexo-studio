    ...
    <nav className="site-nav">
      <div className="site-nav-inner">
        <a href="#" className="site-nav-logo">
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 4, width: 30, height: 30, flexShrink: 0 }}>
          ...
          <span className="site-nav-mark">
            ...
            <span className="site-nav-studio">studio</span>
          </span>
        </a>
        ...
        <a
          ...
          aria-label="Empezar ahora por WhatsApp"
        >
          <WaIcon />
          <span className="site-nav-cta-label">Empezar ahora</span>
        </a>
      </div>
    </nav>
  )
